...
# hpc_tools_local.sh: Unified script for local compilation, graph generation, benchmarking, and comparison
# Usage: ./hpc_tools_local.sh <command> [args]
# Commands:
...
PROJECT_DIR="$HOME/university/parallel_mst"
...
case "$1" in
    ...
    compare) compare ;;
    *)
        echo "Usage: $0 <compile|generate-graphs|benchmark|compare> [args]"
        exit 1
        ;;
esac
